...
class VersionLargeTextExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = VersionLargeTextModel::class;
$this->externalTableName = "text_version_large_text";
