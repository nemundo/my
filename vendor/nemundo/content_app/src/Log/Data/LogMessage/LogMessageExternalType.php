...
class LogMessageExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = LogMessageModel::class;
$this->externalTableName = "log_message";
