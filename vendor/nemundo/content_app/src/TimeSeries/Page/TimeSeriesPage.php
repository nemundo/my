...
use Nemundo\Content\App\TimeSeries\Com\Chart\YearMonthNormalizedChart;
...
use Nemundo\Content\App\TimeSeries\Com\ListBox\WeekListBox;
use Nemundo\Content\App\TimeSeries\Com\ListBox\YearListBox;
use Nemundo\Content\App\TimeSeries\Com\Table\LineTimeSeriesTable;
    ...
    public function getContent()
    {
        ...
        if ($timeSeries->hasValue()) {
            ...
            foreach ($lineReader->getData() as $lineRow) {
                ...
                $site->addParameter(new WidgetLineParameter($lineRow->id));
