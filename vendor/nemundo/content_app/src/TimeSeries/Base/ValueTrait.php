    ...
    public function getValueReader($lineId)
    {
        ...
        if ($this->periodTypeId == (new DayPeriodType())->id) {
            ...
            if ($this->dateFrom !== null) {
                $timeSeriesPeriodTypeReader->filter->andEqualOrGreater($timeSeriesPeriodTypeReader->model->period->date, $this->dateFrom->getIsoDateFormat());
            }

            if ($this->dateTo !== null) {
                $timeSeriesPeriodTypeReader->filter->andEqualOrSmaller($timeSeriesPeriodTypeReader->model->period->date, $this->dateTo->getIsoDateFormat());
            }
