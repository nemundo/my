...
*/
        ...
        $form = new BootstrapForm($this);  // $contentType->getDefaultForm($this);
...
//        foreach ($contentType->getChild() as $treeRow) {
        foreach ($reader->getData() as $treeRow) {


            //$itemDiv = new BootstrapJumbotron($sortableDiv);

//            $itemDiv = new Div($sortableDiv);  // new AdminWidget($sortableDiv);
            ...
            $btn->site->addParameter(new ContentParameter($treeRow->id));*/
            //$btn->site->addParameter(new RefererContentParameter($contentId));
