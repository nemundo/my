...
class ViewContentTypeExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = ViewContentTypeModel::class;
$this->externalTableName = "content_view_content_type";
