...
class ContentIndexExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = ContentIndexModel::class;
$this->externalTableName = "content_content_index";
